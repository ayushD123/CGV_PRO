...
void welcome() {
    ...
    glColor3f(1, 0, 0);
    glRasterPos3f(-1.5, 5.5, 0);
    char msg[] = "Amusement Park";
    for (int i = 0; i < strlen(msg); ++i)
        glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24, msg[i]);
    glRasterPos3f(-4.5, 4.5, 0);
    char msg1[] = "Submitted By: ";
    for (int i = 0; i < strlen(msg1); ++i)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg1[i]);
    glColor3f(1, 1, 0);
    glRasterPos3f(-0.5, 4.5, 0);
    char msg2[] = "Aditya Sudhanshu And Ayush Dixit";
    for (int i = 0; i < strlen(msg2); ++i)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg2[i]);
    glColor3f(1, 0, 0);
    glRasterPos3f(-4.5, 3.5, 0);
    char msg21[] = "USN: ";
    for (int i = 0; i < strlen(msg21); ++i)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg21[i]);
    glColor3f(1, 1, 0);
    glRasterPos3f(-0.5, 3.5, 0);
    char msg22[] = "1RN20CS012 & 1RN20CS029";
    for (int i = 0; i < strlen(msg22); ++i)
        glutBitmapCharacter(GLUT_BITMAP_9_BY_15, msg22[i]);

    glColor3f(0, 0, 1);
    glRasterPos3f(-0.5, -7.0, 0);
    char msg3[] = "Press X To Start";
